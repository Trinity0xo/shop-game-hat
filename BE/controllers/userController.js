  ...
  try {
    ...
    if (!user.isVerified) {
      return res.status(401).json({
        success: false,
        message:
          "Tài khoản chưa được xác minh, vui lòng check email để xác minh",
      });
    }
    ...
    res
      .status(500)
      .json({ success: false, message: "Đã xảy ra sự cố khi đăng nhập" });
  }
};
...
exports.changePassword = async (req, res) => {
  try {
    ...
    res
      ...
      .json({
        success: false,
        message: "Đã xảy ra sự cố khi cập nhật mật khẩu",
      });
  }
};
...
exports.getUser = async (req, res) => {
  try {
    ...
    res
      ...
      .json({
        success: false,
        message: "Đã xảy ra sự cố xuất thông tin chi tiết tài khoản",
      });
  }
};
...
exports.getAllUsers = async (req, res) => {
  try {
    ...
    res
      ...
      .json({
        success: false,
        message: "Đã xảy ra sự cố xuất thông tin người dùng",
      });
  }
};
...
exports.editUser = async (req, res) => {
  try {
    ...
    const { name, phone, city, district, wards, streetAndHouseNumber } =
      req.body;
    if (!name) {
      return res.status(400).json({
        success: false,
...
exports.deleteUser = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ success: false, message: "Đă xảy ra sự cố khi xóa người dùng" });
  }
};
...
exports.changeAdminPassword = async (req, res) => {
  try {
    ...
    res
      ...
      .json({
        success: false,
        message: "Đã xảy ra sự cố khi cập nhật mật khẩu cho admin",
      });
  }
};
...
exports.forgotPassword = async (req, res) => {
  try {
    ...
    res
      ...
      .json({
        success: false,
        message: "Đã xảy ra sự cố khi yêu cầu đặt lại mật khẩu",
      });
  }
};
...
exports.resetPassword = async (req, res) => {
  try {
    ...
    res
      ...
      .json({
        success: false,
        message: "Đã xảy ra sự cố khi đặt lại mật khẩu",
      });
  }
};
